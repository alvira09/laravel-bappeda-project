    ...
    <body>
        <aside id="sidebar" class="sidebar">
            ...
            <ul class="sidebar-nav" id="sidebar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link collapsed" href="dashboard-k.html">
                ...
                <li class="nav-item">
                    <a class="nav-link collapsed" href="riwayat-k.html">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row justify-content-end">
                                ...
                                <div class="col-md-4">
                                    <div class="row justify-content-end">
                                        <div class="col-md-3">
                                            <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#print">Print</button>
                                        </div>
                                        <div class="col-md-4">
